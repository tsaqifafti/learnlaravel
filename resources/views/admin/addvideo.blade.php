...
@endif
            ...
            <h6><a class="text-secondary text-decoration-none" href="dashboard"> Dashboard </a> <i class="fas fa-arrow-right mx-2"></i> <span class="text-primary">Add Video</span></h6>
            <h1>Add Video</h1>
  ...
  <div class="custom-file">
    <input type="file" class="custom-file-input" name="video" id="inputGroupFile03" accept="video/*" onchange="updateFileName(this)">
