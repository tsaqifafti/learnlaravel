                ...
                <div class="p-5">
                  ...
                  <form  class="user" action="{{ route('admin.login') }}" method="POST">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="email_address" name="email" aria-describedby="emailHelp" placeholder="Enter Username atau Email Address...">
                    </div>
                    <div class="form-group">
