...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::post('admin/addmitra', [mitraController::class, 'store'])
                ->name('admin.addmitra');   

    Route::post('admin/addvideo', [VideoController::class, 'store'])
                ->name('admin.upload');

    Route::get('admin/addvideo', [VideoController::class, 'create']);

    Route::get('admin/editvideo', [VideoController::class, 'edit']);

    Route::get('admin/dashboard', [VideoController::class, 'fetch'])->name('admin.dashboard');
